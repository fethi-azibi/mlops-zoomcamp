...
from utils.data_preparation.encoders import vectorize_features
from utils.data_preparation.feature_selector import select_features
from utils.data_preparation.artifacts import save_to_artifacts
...
def export(
    ...
    X_path = save_to_artifacts(X, "X.pkl")
    X_train_path= save_to_artifacts(X_train, "X_train.pkl")
    X_val_path= save_to_artifacts(X_val, "X_val.pkl")
    y_path= save_to_artifacts(y, "y.pkl")
